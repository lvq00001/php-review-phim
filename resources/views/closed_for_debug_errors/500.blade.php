    ...
    <body>
        <div class="container error">
            <div class="pt-5 d-flex flex-column align-items-center">
                <h1>4<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor"
                        class="bi bi-bug mx-2" viewBox="0 0 16 16">
                        <path
                ...
                <h3 class="mt-4">Không tìm thấy trang</h3>
                <p>Không thể tìm được trang mà bạn yêu cầu!</p>
                <div class="mt-5 ">
                    <a href="/" type="button" class="btn m-2 m-md-0 btn-primary"><i class="bi bi-house-door-fill"></i>
                        Về trang chủ
                    </a>
                </div>
            </div>
            <!-- <img src="" alt="glass" class="error" /> -->
        </div>
